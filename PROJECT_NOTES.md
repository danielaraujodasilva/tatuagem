...
- `crm/index.php`: entrada do CRM, carregando a Central de Atendimento.
- `crm/dashboard.php`: dashboard/pipeline antigo do CRM.
- `crm/atendimento.php`: inbox geral de conversas com filtros, bot/humano, assumir conversa, status, chat, anexos, audio, transcricao, agenda e respostas rapidas.
