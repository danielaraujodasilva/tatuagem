...
function cleanBlock(mixed $raw): array
{
    ...
    return [
        ...
        'progress_percent' => min(100, max(0, (float) ($raw['progress_percent'] ?? 0))),
        'stage_index' => max(0, (int) ($raw['stage_index'] ?? 0)),
        'stage_count' => max(0, (int) ($raw['stage_count'] ?? 0)),
        'stage_label' => cleanText($raw['stage_label'] ?? '', 80),
