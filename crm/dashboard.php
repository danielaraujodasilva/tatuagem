...
<head>
    ...
    <style>
        ...
        .dashboard-shell .rounded-3xl {
            border-radius: 8px !important;
        }

        .dashboard-shell .bg-gray-900,
        .dashboard-shell .bg-gray-800 {
            background-color: rgba(16, 17, 20, 0.94) !important;
        }

        .dashboard-shell .border-gray-800,
        .dashboard-shell .border-gray-700 {
            border-color: rgba(255, 255, 255, 0.08) !important;
        }

        .dashboard-shell .bg-emerald-600,
        .dashboard-shell .bg-blue-600,
        .dashboard-shell .bg-sky-500 {
            background: linear-gradient(180deg, #e11d28, #b91420) !important;
            color: #fff !important;
        }

        .dashboard-shell .text-emerald-400,
        .dashboard-shell .text-emerald-500 {
...
<body class="crm-shell">
    <div class="dashboard-shell w-full mx-auto">
        <div class="bg-black/50 border-b border-red-950/60 px-6 py-6">
            <div class="flex flex-col gap-6">
                <div class="flex items-center gap-3">
                    <i class="fas fa-chart-simple text-3xl text-red-500"></i>
                    <div>
                        <div class="crm-eyebrow mb-1"><i class="fa-solid fa-gauge-high"></i> CRM & Ficha</div>
                        <h1 class="crm-title text-3xl">Dashboard <strong>CRM</strong></h1>
                    </div>
                </div>
