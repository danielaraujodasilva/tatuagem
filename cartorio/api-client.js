document.addEventListener('submit',async event=>{
  ...
  const service=form.closest('dialog')?.dataset.service||form.querySelector('[data-service]')?.dataset.service||document.querySelector('[data-service]')?.dataset.service||'outros';
