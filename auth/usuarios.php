  ...
  <main class="ficha-shell">
    <section class="ficha-frame">
      <header class="ficha-hero">
        ...
        <div class="ficha-nav">
          <a class="btn ficha-btn ficha-btn-secondary" href="../crm/index.php">CRM</a>
          <a class="btn ficha-btn ficha-btn-secondary" href="../ficha/public/clientes.php">Clientes</a>
          <a class="btn ficha-btn ficha-btn-secondary" href="logout.php">Sair</a>
        </div>
      </header>
